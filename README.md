...
> 1. 여러 명이서 하는 활동을 하고 싶지만 인원이 부족한 사람
> 2. 같은 취미를 공유하는 사람들끼리 지속적으로 연락을 취하고 싶은 사람
> 3. 자신의 취미를 바탕으로 지역 내 대회를 열고 싶거나 참여하고 싶은 사람
            
#### 주요 기능

> 1. 놀이 관련 활동에서 인원이 필요할 경우, 매칭 진행
> 2. 매칭 종료 후, 상호 간 평가를 통해 유저에 대한 정보 축적 (매너, 게임이해도 등)
> 3. 특정 놀이에 대한 대회(리그/토너먼트)를 개최하거나 참여 가능
> 4. 같은 취미를 공유하는 사람들끼리 크루(그룹)을 형성
